...
function buildBoard(jobs, events, tasks) {
  // De-duplicate tasks by id. In domain-wide mode the same shared task can be
  // returned from several users' lists, which otherwise shows up repeated on a
  // card. Keep the first occurrence of each id.
